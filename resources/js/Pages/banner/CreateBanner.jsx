...
const CreateBanner = ({ user }) => {
    // Define state
    const [nama, setNama] = useState('');
    const [deskripsi, setDeskripsi] = useState('');
    const [gambarPreview, setGambarPreview] = useState(null); // State for preview image
    const [gambar, setGambar] = useState(null); // State for original image file
                ...
                <div id="layoutSidenav_content">
                    <main>
                        <div className="container my-5 p-5">
                            <h1 className="mb-4">Create Banner</h1>
                            ...
                            <form onSubmit={storePost}>
                                ...
                                <div className="d-grid gap-2 d-md-flex justify-content-md-start">
                                    <button type="submit" className="btn btn-primary me-md-2">Tambah Banner</button>
